...
[testing-python-libraries](../testing-python-libraries/SKILL.md). This skill is
...
fixing (see [reporting-derived-metrics](../reporting-derived-metrics/SKILL.md)); the
...
[testing-python-libraries](../testing-python-libraries/SKILL.md) for confirming
...
[shipping-across-surfaces](../shipping-across-surfaces/SKILL.md) for choosing between
...
[reporting-derived-metrics](../reporting-derived-metrics/SKILL.md) for a worked example of
reading that signal.
